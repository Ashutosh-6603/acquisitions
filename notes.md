...
- **Security layering:** Arcjet is configured globally in `src/config/arcjet.js` _and_ `security.middleware.js` adds another per-role limiter, which may be redundant.
- **Security defaults:**
